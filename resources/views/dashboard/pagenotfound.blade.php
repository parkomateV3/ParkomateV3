...
<body class=" font-inter skin-default">
    ...
    <div class="min-h-screen flex flex-col justify-center items-center text-center py-10">
        ...
        <div class="max-w-[300px] mx-auto w-full">
            <a href="{{ url('dashboard/home') }}" class="btn btn-dark dark:bg-slate-800 block text-center">
                Go to homepage
            </a>
        </div>
    </div>
